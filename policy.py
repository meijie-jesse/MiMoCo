...
import torch
import numpy as np
from mimoco_models.main import build_chunk_seq_model_and_optimizer, build_CNNMLP_model_and_optimizer
import IPython
e = IPython.embed
...
class ChunkSeqPolicy(nn.Module):
    def __init__(self, args_override):
        super().__init__()
        model, optimizer = build_chunk_seq_model_and_optimizer(args_override)
